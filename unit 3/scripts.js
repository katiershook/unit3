...
//store the value of the selected boxes data
...
if((dateSelected=== selectedTime) && selectedTime.attr('name') !== dateSelected.attr('name'))
{
 if (selectedTime.is(':checked')){
                             
   dateSelected.prop('disabled', true);
...
//}
//loop through boxes 
//check if their date is the same 
//if date is the same check time 
//if the time is the same then disable 
